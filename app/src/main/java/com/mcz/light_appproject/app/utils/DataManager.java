...
//命令下发
    public static String Comened_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String deviceId,String LED)
            throws Exception{
        List<NameValuePair> params = new ArrayList<NameValuePair>();

        params.add(new BasicNameValuePair("deviceId", deviceId));
        params.add(new BasicNameValuePair("serviceId", "Light"));
        params.add(new BasicNameValuePair("method", "Control"));
        params.add(new BasicNameValuePair("LED", LED));
        String json = NETCommned.request(mContext, NETCommned.REQUEST_TYPE_POST,
                serverurl,app_key,accessToken, params);
        return json;
    }
    public static String Comened_DEVICEID2(Context mContext, String serverurl,String app_key,String accessToken,String deviceId,String LED)
            throws Exception{
        List<NameValuePair> params = new ArrayList<NameValuePair>();
...
//删除直连设备
    ...
    public static String UPDATE_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String name)
        ...
        params.add(new BasicNameValuePair("model", "Light"));
